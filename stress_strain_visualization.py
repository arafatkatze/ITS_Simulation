...
def stress_strain(out, pb, state, extend=False):
    ...
    stress = ev('ev_cauchy_stress.2.Omega(Asphalt.D, u)', mode='el_avg', copy_materials=False)

    out['eng_strain'] = Struct(name='output_data', mode='cell',
                                  data=strain, dofs=None)
    out['eng_stress'] = Struct(name='output_data', mode='cell',
